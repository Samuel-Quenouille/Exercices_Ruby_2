...
puts "Question 4 : Combien commencent par une majuscule (première lettre juste après le @) ?"
    capital_string = handle_twitter.select{|str| str =~ /@([A-Z])/}.count
puts "Réponse : Le nombre de handle qui commencent par une majuscule est de #{capital_string}"
puts "============="

# Quelle est la position dans l'array de la personne @epenser ?
puts "Question 5 : Quelle est la position dans l'array de la personne @epenser ?"
    index_in_array = handle_twitter.index("@epenser")
puts "La personne @epenser est en #{index_in_array}ème position"
puts "============="

# Trie la liste de handle par ordre alphabétique.
puts "Question 6 : Trie la liste de handle par ordre alphabétique :"
    order_string = handle_twitter.sort_by{|str| str.split("@").last.downcase}
puts order_string
puts "============="

# Trie la liste de handle par taille des handle (les plus petits en premiers, les plus grands après)
puts "Question 7 : Trie la liste de handle par taille des handle (les plus petits en premiers, les plus grands après)"
    size_string = handle_twitter.sort_by{|str| str.length}
puts size_string
puts "============="
